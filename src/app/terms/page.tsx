          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground mb-4">
                ...
                remain the exclusive property of Chronos and its licensors. The Service is protected
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground mb-4">
                In no event shall Chronos, nor its directors, employees, partners, agents,
