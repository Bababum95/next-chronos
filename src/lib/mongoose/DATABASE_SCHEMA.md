...
Проект Chronos использует MongoDB в качестве основной базы данных для хранения пользовательских данных и heartbeat'ов (данных активности). База данных состоит из двух основных коллекций: `users` и `heartbeats`.
